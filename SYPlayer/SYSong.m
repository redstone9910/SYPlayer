...
-(BOOL)updeteCheckInDir:(NSString *)dir{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:self.localPath]){
        ...
        NSString *sPath = [[[[bundle resourcePath] stringByAppendingPathComponent:@"Assets"] stringByAppendingPathComponent:dir] stringByAppendingPathComponent:name];//查找resource目录
